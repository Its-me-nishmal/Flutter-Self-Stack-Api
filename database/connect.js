...
const connect = async () => {  
    try {
        dotenv.config();
        const MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://alltrackerx:Nichuvdr%40786@cluster0.zqjk0it.mongodb.net/FLUTTER_SELF-STACK?retryWrites=true&w=majority'
